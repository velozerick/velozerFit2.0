...
public class PiernasActivity extends AppCompatActivity {
    ...
    private void configurarListenersIconos() {
        ...
        iconoEjercicio.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/shorts/UbIClfnHOuw");
        });

        iconoEjercicio1.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/shorts/mlEfhtj-4_8");
        });

        iconoEjercicio2.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/shorts/7BdVi5qJ7E4");
        });

        iconoEjercicio3.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/watch?v=cYkfb9mWoJA");
        });

        iconoEjercicio4.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/watch?v=U_Bw3t2ARdM");
        });
    }
