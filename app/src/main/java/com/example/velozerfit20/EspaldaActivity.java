...
public class EspaldaActivity extends AppCompatActivity {
    ...
    private void configurarListenersIconos() {
        ...
        iconoEjercicio.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/watch?v=aAggnpPyR6E");
        });

        iconoEjercicio1.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/watch?v=qGxSGldH1l8");
        });

        iconoEjercicio2.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/watch?v=fgA4bGIKsn8");
        });

        iconoEjercicio3.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/watch?v=JGeRYIZdojU");
        });

        iconoEjercicio4.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/watch?v=yPqv3ejnZvc");
        });
    }
