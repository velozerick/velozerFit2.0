...
public class PechoActivity extends AppCompatActivity {
    ...
    private void configurarListenersIconos() {
        ...
        iconoEjercicio.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/watch?v=wYXFJZEdZ3A");
        });

        iconoEjercicio1.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/shorts/WjdE5DLGDdo");
        });

        iconoEjercicio2.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/watch?v=sNXrm1GjfH8");
        });

        iconoEjercicio3.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/watch?v=jOVdULm5b70");
        });

        iconoEjercicio4.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/shorts/1fR3Ss8OFug");
        });
    }
