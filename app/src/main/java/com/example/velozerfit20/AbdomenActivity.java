...
public class AbdomenActivity extends AppCompatActivity {
    ...
    private void configurarListenersIconos() {
        ...
        iconoEjercicio.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/watch?v=JWUyng_c-G0");
        });

        iconoEjercicio1.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/shorts/VDfAZvFMHiI");
        });

        iconoEjercicio2.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/watch?v=apmprS8H1MY");
        });

        iconoEjercicio3.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/watch?v=WHEppHwqVUw");
        });

        iconoEjercicio4.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/watch?v=Tau0hsW8iR0");
        });
    }
