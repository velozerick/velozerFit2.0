...
public class Biceps extends AppCompatActivity {
    ...
    private void configurarListenersIconos() {
        ...
        iconoEjercicio.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/watch?v=no-dXip-rJM");
        });

        iconoEjercicio1.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/watch?v=j99intoPKGE");
        });

        iconoEjercicio2.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/watch?v=Is3JRhq37o4");
        });

        iconoEjercicio3.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/watch?v=TuS1rJQrJqE");
        });

        iconoEjercicio4.setOnClickListener(v -> {
            abrirURL("https://www.youtube.com/watch?v=mFgTFstIfFs");
        });
    }
